...
Partial Public Class App
    ...
    Sub InitXpoDataLayer()
        Dim XpoWebServiceUri As String = New Uri(Application.Current.Host.Source, "/XpoGate.asmx").AbsoluteUri
        Dim address As New EndpointAddress(XpoWebServiceUri)
        Dim binding As New BasicHttpBinding()
        binding.MaxReceivedMessageSize = Int32.MaxValue
        Dim dataStore As New XpoGateSoapClient(binding, address)
